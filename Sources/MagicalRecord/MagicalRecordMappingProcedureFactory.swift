...
public class MagicalRecordMappingProcedureFactory: ResponseMappingProcedureFactory {
    ...
    /// data manipulation inside `MagicalRecordMappingProcedure`. If `nil` set, `MagicalRecordMappingProcedure` will create context and save changes to persisten store. If not `nil`, `save` method will not be called. Default value: `nil`
    ...
    /// - throws: `MagicalRecordMappingProcedureError.unsupportedType` if `type` is not `NSManagedObject` subclass, nor `Array` of `NSManagedObject` subclass.
